...
<head>  
    ...
    <style>  
        ...
        .button {  
            ...
            cursor: pointer;  
            transition: background 0.3s;  
            text-decoration: none; /* Предотвращает подчеркивание текста на кнопке */  
...
<body>  
    ...
    <div class="content">  
        ...
        <div class="button-container">  
            <a href="https://drive.usercontent.google.com/download?id=1G2AUWPlsuwI6gHmk4t_8tVIj0qhoorkU&export=download&authuser=0" class="button">Начать игру</a>  
        </div>  
    </div>  
</body>  
</html>
